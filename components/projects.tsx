      ...
      {projects.map(project => (
        <li key={project.slug} className="group relative">
          <Link href={`/projects/${project.slug}`}>
            ...
            <div className="absolute inset-x-0 bottom-0 translate-y-2 px-6 py-5 opacity-100 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
